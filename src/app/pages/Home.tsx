...
import { Briefcase, Mail, ArrowRight, Sparkles, Code, Palette, Coffee, Star } from "lucide-react";
        ...
        <div className="text-center mb-12">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#F4743B]/20 bg-[#F4743B]/10 mb-6"
            >
              <Sparkles className="w-4 h-4 text-[#F4743B]" />
              <span className="text-sm text-[#F4743B]" style={{ fontWeight: 500 }}>About Me</span>
            </motion.div>
